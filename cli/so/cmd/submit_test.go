...
func TestSubmitCommand(t *testing.T) {
	...
	t.Run("Submit with PR discovery", func(t *testing.T) {
		...
		mockClient.On("GetPullRequest", 201).Return(
			&github.PullRequest{Number: github.Ptr(201), HTMLURL: github.Ptr("url-a"), Base: &github.PullRequestBranch{Ref: github.Ptr("main")}}, nil,
		).Once()
		...
		mockClient.On("CreateComment", 201, mock.AnythingOfType("string")).Return(
			&github.IssueComment{ID: github.Ptr(int64(5001))}, nil,
		).Once()
