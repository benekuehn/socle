    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">The stack is determined by the tracking information set via 'so track'. This command finds the first branch after the base in the sequence leading to the top.</p>
        ...
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">The stack is determined by the tracking information set via 'so track'. This command finds the immediate parent of the current branch.</p>
        ...
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">Shows the sequence of tracked branches leading from the stack's base branch to the current branch, based on metadata set by 'so track'.</p>
        ...
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">The stack is determined by the tracking information set via 'so track'. This command finds the last branch in the sequence starting from the base branch.</p>
        ...
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">Associates the current branch with a parent branch to define its position within a stack. This allows 'so show' to display the specific stack you are on.</p>
        ...
        <section>
          ...
          <p className="mb-4 text-zinc-700 dark:text-zinc-300">The stack is determined by the tracking information set via 'so track'. This command finds the immediate descendent of the current branch.</p>
