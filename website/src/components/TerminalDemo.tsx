...
export const TerminalDemo: React.FC = () => {
    ...
    return (
        <motion.div
            className='hidden md:block w-full max-w-4xl mx-auto px-4 sm:px-6'
        ...
        >
            <div className='text-center mb-6'>
                <div className='inline-flex items-center px-4 py-2 gap-2'>
                    <span>$</span>
                    <span className='font-mono text-zinc-50'>{typedCommand}</span>
                </div>
                ...
                <div
                    ...
                    style={{
                        ...(terminalHeight
                            ...
                            : { maxHeight: MAX_HEIGHT, minHeight: MIN_HEIGHT }),
