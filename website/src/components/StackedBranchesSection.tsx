...
const paragraphs = [
    {
        ...
        content:
            "Achieve continuous, productive flow. Stacking enables parallel work and review, eliminating waits.",
    },
    {
        title: "Foster Clarity, Enable Better Reviews",
        content:
            "Foster clarity with focused PRs. Stacking enables insightful, efficient reviews with ease.",
    },
    {
        title: "Deliver Value Sooner, Build Momentum",
        content:
            "Ship value incrementally. Stacking enables shared team momentum and confident, progressive achievements.",
    },
];
...
const BaseSVG = () => (
    ...
    >
        <path
            d='M390.998 111.714L196 225.167L1.00098 111.714L196 0.575195L390.998 111.714Z'
...
const MiddleSVG = () => (
    ...
    >
        <path
            d='M298.331 85.1152L150 171.418L1.66766 85.1162L150 0.575195L298.331 85.1152Z'
            fill='url(#paint0_linear_1_127)'
            stroke='url(#paint1_linear_1_127)'
        />
        <path
            d='M0.666626 85.1113L150 171.996V195.047L0.666626 108.162V85.1113Z'
            fill='url(#paint2_linear_1_127)'
        />
        <path
            d='M150 195.047L299.333 108.163V85.1115L150 171.996V195.047Z'
...
const TopSVG = () => (
    ...
    >
        <path
            d='M108 0L215.333 61.174L108 123.622L0.666687 61.174L108 0Z'
            fill='url(#paint0_linear_1_131)'
        />
        <path
            d='M0.666687 61.1738L108 123.622V140.19L0.666687 77.7417V61.1738Z'
            fill='url(#paint1_linear_1_131)'
        />
        <path
            d='M108 140.191L215.333 77.742V61.1741L108 123.623V140.191Z'
            fill='url(#paint2_linear_1_131)'
        />
        <defs>
            <linearGradient
...
export function StackedBranchesSection() {
    ...
    return (
        <section ref={sectionRef} className='relative w-full bg-zinc-950'>
            <div className='w-full flex justify-center pt-10 relative z-10 -mb-64'>
                <motion.h2
            ...
            <div className='max-w-6xl mx-auto grid md:grid-cols-2 h-full'>
                <div className='h-full flex flex-col'>
                            ...
                            {visibleIdx !== null && (
                                ...
                                >
                                    <h3 className='text-xl font-semibold text-zinc-200'>
                                        {paragraphs[visibleIdx].title}
                                    </h3>
                                    <p className='text-zinc-400 max-w-md mx-auto'>
                                        {paragraphs[visibleIdx].content}
                                    </p>
                                    <div
                                        style={{
                                            height: "2.5rem",
                    ...
                    <div ref={triggerRef0} style={{ height: `0.5vh` }} aria-hidden />
                    <div ref={triggerRef1} style={{ height: `40vh` }} aria-hidden />
